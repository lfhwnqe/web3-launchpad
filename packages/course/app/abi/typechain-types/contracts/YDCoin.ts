...
export interface YDCoinInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "INITIAL_SUPPLY"
      | "MAX_SUPPLY"
...
export interface YDCoin extends BaseContract {
  connect(runner?: ContractRunner | null): YDCoin;
  waitForDeployment(): Promise<this>;

  interface: YDCoinInterface;
